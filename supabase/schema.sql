...
create table if not exists public.site_settings (
  ...
  use_gradient_bg boolean not null default false,
...
alter table public.site_settings add column if not exists use_gradient_bg boolean not null default false;
