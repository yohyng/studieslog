...
function articleBodyToEmail(html, s) {
    ...
    out = out.replace(
        ...
        (whole, _legacyWrap, legacyText) => {
            ...
            notes.push(note);
            return `<sup style="color:${s.footnoteColor}; font-size:0.75em; line-height:0;">[${notes.length}]</sup>`;
        }
    );
 ...
 */
function buildDigestHtml({ siteTitle, siteUrl, articles, unsubscribeUrl, bgColor, textColor, fontFamily, typography }) {
    const t = typography || {};
    ...
    const articleBlocks = articles.map(a => {
        ...
        return `
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                   style="border-collapse:separate; margin-bottom:${framePad}px;">
                <tr>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td align="center" style="padding-bottom: 40px;">
                            ...
                            <div style="font-size:${titleSize}px; color:${text}; font-family:${titleFont}; letter-spacing:0.1em;">${escapeHtml(siteTitle)}</div>
                        </td>
                    </tr>
                    <tr>
